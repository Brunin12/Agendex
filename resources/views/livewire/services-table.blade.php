        ...
        <tbody class="bg-white">
            @foreach ($services as $service)
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="border border-gray-300 px-4 py-2">{{ $service->duration }}</td>
                    <td class="border border-gray-300 px-4 py-2">R$ {{ $service->price }}</td>
                    <td class="border border-gray-300 px-4 py-2"> {{ $service->user?->name ?? '—' }}</td>
                    <td class="border border-gray-300 px-4 py-2">{{ $service->created_at }}</td>
                    <td class="border border-gray-300 px-4 py-2">{{ $service->updated_at }}</td>
                    <td class="border border-gray-300 px-4 py-2 h-full">
